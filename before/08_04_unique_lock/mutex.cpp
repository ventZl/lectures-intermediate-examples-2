...
int main(int, char **) {
    ...
    threads.resize(3);
    /* TODO: These three threads execute three special routines.
     * Each of routines does something different. They all use
     * shared system resources in a thread-safe manner: they lock
     * them before use.
     *
     * This approach causes deadlocks as resources may become locked
     * concurrently and prevent threads from proceding.
     *
     * Fix the code to never deadlock, use std::unique_lock and
     * std::lock to perform the fix.
     */
